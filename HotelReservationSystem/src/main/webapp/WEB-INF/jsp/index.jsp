...
<head>
    ...
    <style>
        body {
       <!--  background-image: url('file:///D:/Anudipjava/Batch5904/SprintProject/hotelimage.jpg'); /* Set the background image path */
...
<body>
    ...
    <!-- Add moving text on the right side -->
    <!-- <div class="vertical-text">We Are Happy To See You Here</div> -->
</body>
</html>